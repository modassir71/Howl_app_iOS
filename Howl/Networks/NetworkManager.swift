...
class NetworkManager: NSObject, URLSessionDelegate{
    ...
    let dataManager = WalkStatusManager.sharedInstance
                ...
                if let upperDictionary = data.jsonDataToDictionary() {
                    ...
                    if let innerData = upperDictionary["data"]?.convertStringtoDatatoArray() {
                        ...
                        for instance in innerData {
                            ...
                            dataManager.monitorYouNullDataCounter = 0
                            dataManager.updateMonitorYouOutput(output: instance)
                        }
                    } else {
                        
                        if dataManager.monitorYouNullDataCounter == 360 {
                            ...
                            dataManager.monitorYouNullDataCounter += 1
                        }
                    }
                } else {
