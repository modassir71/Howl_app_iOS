...
class PolicyViewController: UIViewController, WKNavigationDelegate, WKUIDelegate {
    //MARK: - Outlet
...
//    MARK: - LOad web view
    func _loadWebView(){
        if let url = URL(string: "https://www.howlforhelp.com/privacy-policy") {
    ...
    //    MARK: - SetCorner Radius
        ...
        @IBAction func navigateManuallyBtnPress(_ sender: UIButton) {
            ...
            case 3:
                let urlString = "https://www.howlforhelp.com/privacy-policy"
